...
public class Planet {
              ...
              public static void main(String[] args) {
                  ...
                  planets =  sunSystem.generate();
                  System.out.println(" Все планеты ");
                  for (Planet p : planets) {
                      System.out.println(" Планета " + p.getPlanetEnum()
                              + " мaсса = " + p.getMass()
                              + " радиус " + p.getRadius()
                              + " радиус орбиты " + p.getRadiusOrbit());

                  }
                  System.out.println("Выбрать Землю");
                  Planet p = sunSystem.returnParametr(planets, PlanetEnum.Earth);
 ...
 class SunSystem
{
    ...
    public  Planet returnParametr(List<Planet> planets, PlanetEnum planetEnum)
    {
        for (Planet p : planets)
        {
            if (p.getPlanetEnum() == planetEnum)
            {
